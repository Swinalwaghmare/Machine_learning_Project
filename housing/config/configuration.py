...
DataTransformationConfig, MoldeTrainerConfig, ModelPusherConfig, ModelEvaluationConfig,\
...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            tgz_download_dir = os.path.join(data_ingestion_artifact_dir,data_ingestion_info
    ...
    def get_model_trainer_config(self) -> MoldeTrainerConfig:
        pass
